 ...
 * - `clockTime`    — "12" / "24"
 *
 * @returns {{speedUnit: string, lengthUnit: string, distanceUnit: string, clockTime: string}}
 */
export function detectSystemDefaults() {
  ...
  // imperial (mph, miles).
  const presets = {
    us:     { speedUnit: "mph", lengthUnit: "in", distanceUnit: "mi" },
    uk:     { speedUnit: "mph", lengthUnit: "mm", distanceUnit: "mi" },
    metric: { speedUnit: "kmh", lengthUnit: "mm", distanceUnit: "km" },
  };
  return {
    ...presets[system],
